...
function quaddata(op::IntegralOperator,
    test_local_space::RefSpace, trial_local_space::RefSpace,
    test_charts::Vector{CompScienceMeshes.Simplex{<:Any, 3}}, trial_charts::Vector{CompScienceMeshes.Simplex{<:Any, 3}}, qs::SauterSchwab3DQStrat)
...
function quaddata(op::IntegralOperator,
    test_local_space::RefSpace, trial_local_space::RefSpace,
    test_charts::Vector{CompScienceMeshes.Simplex{<:Any, 2}}, trial_charts::Vector{CompScienceMeshes.Simplex{<:Any, 3}}, qs::SauterSchwab3DQStrat)
...
function quaddata(op::IntegralOperator,
    test_local_space::RefSpace, trial_local_space::RefSpace,
    test_charts::Vector{CompScienceMeshes.Simplex{<:Any, 3}}, trial_charts::Vector{CompScienceMeshes.Simplex{<:Any, 2}}, qs::SauterSchwab3DQStrat)
