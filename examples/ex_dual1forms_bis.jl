...
faces_supp1 = CompScienceMeshes.skeleton_fast(supp1, 2)
faces_supp2 = CompScienceMeshes.skeleton_fast(supp2, 2)
faces_supp3 = CompScienceMeshes.skeleton_fast(supp3, 2)
...
dir = submesh(in(bnd_tetrs), bnd_supp)
# dir = submesh(face -> sort(face) in srt_bnd_tetrs, bnd_supp)
rim = boundary(dir)
@show length(dir)

# Step 1: step port flux and extend
...
# cells_faces_supp1 = sort.(faces_supp1)
# cells_faces_supp2 = sort.(faces_supp2)
# cells_faces_supp3 = sort.(faces_supp3)

dFace1 = submesh(in(faces_supp2), faces_supp3)
dFace2 = submesh(in(faces_supp3), faces_supp1)
dFace3 = submesh(in(faces_supp1), faces_supp2)
