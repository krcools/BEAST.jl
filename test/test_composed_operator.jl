...
M_displaced = assemble(K,Xd,X;quadstrat = [BEAST.DoubleNumSauterQstrat(6,6,6,6,6,6),BEAST.SingleNumQStrat(6)])
...
M_displaced = assemble(K,Xdm,X;quadstrat = [BEAST.DoubleNumSauterQstrat(6,6,6,6,6,6),BEAST.SingleNumQStrat(6)])
